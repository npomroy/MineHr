...
public class MHDryingSeed extends Item implements IPlantable
{
    ...
    public MHDryingSeed(Block p_i45352_1_, Block p_i45352_2_)
    {
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        {
            if (par3World.getBlock(par4, par5, par6) == MineHr.blockStage && par3World.isAirBlock(par4, par5 + 1, par6))
            {
